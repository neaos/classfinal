 ...
 * 启动2 java -jar this.jar -file springboot.jar -libjars a.jar,b.jar -packages com.neaos,yiyon.com -exclude org.spring -pwd 995800 -Y
 *
 * @author neaos
 */
public class Main {
...
//            cfgfiles = scanner.nextLine();
        ...
        //test数据
        if ("1".equals(path)) {
            path = "/Users/neaos/fsdownload/yiyon-package-liuyuan-1.0.0.jar";
            libjars = "yiyon-*.jar,aspectjweaver-1.8.13.jar,a.jar";
            packages = "com.yiyon,com.neaos.*";//包名过滤
            excludeClass = "org.spring.*";//排除的类
            password = "123456";
            classpath = "/Users/neaos/code-space/apache-tomcat-8.5.32/lib";
            cfgfiles = "*.yml";
            Const.DEBUG = false;
        } else if ("2".equals(path)) {
            path = "/Users/neaos/code-space/pig_project/target/pig_project_maven.war";
            packages = "com.neaos";//包名过滤
            excludeClass = "org.spring";//排除的类
            password = "#";
            classpath = "/Users/neaos/code-space/apache-tomcat-8.5.32/lib";
            Const.DEBUG = true;
        } else if ("3".equals(path)) {
            path = "/Users/neaos/Desktop/iyun.node.dicomserver.jar";
