...
##### Gitee: https://github.com/neaos/classfinal.git
...
### 下载
[点此下载](https://repo1.maven.org/maven2/com.neaos/classfinal-fatjar/1.2.1/classfinal-fatjar-1.2.1.jar)
...
```xml
<plugin>
    <!-- https://github.com/neaos/classfinal.git -->
    <groupId>com.neaos</groupId>
...
* v1.1.7 支持加密springboot的配置文件；
* v1.1.5 增加无密码加密方式，启动无需输密码
* v1.0.0 第一个正式版发布
